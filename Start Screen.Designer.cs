namespace MultiLevel_Game_Project_V._3
{
    partial class Start_Screen
    {
        ...
        private void InitializeComponent()
        {
            ...
            label1.Location = new Point(121, 226);
            label1.Name = "label1";
            label1.Size = new Size(543, 92);
            label1.TabIndex = 0;
            label1.Text = "The quest begins. \r\nYou need to overcome many trials to save the princess.\r\nAre you up for the challenge?\r\nIf so, click here to begin.";
            label1.TextAlign = ContentAlignment.MiddleCenter;
            label1.Click += OnClickEvent;
            // 
            // Start_Screen
            // 
